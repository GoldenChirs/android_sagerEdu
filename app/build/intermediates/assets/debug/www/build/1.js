...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__about__ = __webpack_require__(859);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular2_moment__ = __webpack_require__(860);
...
var AboutPage = (function (_super) {
    ...
    function AboutPage(navCtrl, navParams, userService, commonService) {
        var _this = _super.call(this, navCtrl, navParams, userService) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.userService = userService;
        _this.commonService = commonService;
        _this.malePic = "assets/imgs/profile/male.png";
        _this.femailPic = "assets/imgs/profile/female.png";
        _this.header_title = __WEBPACK_IMPORTED_MODULE_2__providers_setting_setting__["a" /* SettingProvider */].pageSettings.AboutPage.pageTitle;
        _this.userDetail = new __WEBPACK_IMPORTED_MODULE_3__shared___["j" /* UserDetail */]();
        return _this;
    }
    //TODO: should use flatmap..
    AboutPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        var loader = this.commonService.presentLoading();
        this.userDetailSubscription = this.userService.currentUser.subscribe(function (user) {
            _this.userService.getUserDetail(user).subscribe(function (userDetail) {
                _this.userDetail = userDetail;
                if (_this.userDetail) {
                    if (_this.userDetail.gender) {
                        _this.userDetail.pic = _this.malePic;
                    }
                    else {
                        _this.userDetail.pic = _this.femailPic;
                    }
                }
            }, function (error) {
                _this.commonService.dismissLoading(loader);
            }, function () {
            });
        });
    };
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\Chris\Desktop\Sandbox\SagerEducation\src\pages\about\about.html"*/'<ion-header>\n    <page-header [header]="header_title"></page-header>\n</ion-header>\n\n<ion-content>\n\n    <ion-item class="profile-pic">\n        <ion-avatar>\n                <img src="{{userDetail.pic}}" alt="Profile Pic"/>\n                <!-- <img *ng-if = "{{userDetail.gender}} == false" src="assets/imgs/profile/female.png" alt="Profile Pic"/> -->\n        </ion-avatar>\n        <h1 padding-top text-center> {{userDetail.firstName}} {{userDetail.lastName}} </h1>\n</ion-item>\n\n<ion-list no-padding>\n         <ion-item>\n                <ion-icon name="calendar" color="primary" item-left></ion-icon>\n                 <h2>Registration Time</h2>\n                 <p><ion-note><time>{{userDetail.regDate | date:\'yyyy-MM-dd HH:mm a \':\'+0000\'}}</time></ion-note></p>\n         </ion-item>\n        \n        <ion-item>\n                <ion-icon name="mail" color="primary" item-left></ion-icon>\n                <h2>Email</h2>\n                <p><ion-note>{{userDetail.email}}</ion-note></p>\n        </ion-item>\n        <ion-item>\n                <ion-icon name="call" color="primary" item-left></ion-icon>\n                <h2>Phone number</h2>\n                <p><ion-note>{{userDetail.homePhone}}</ion-note></p>\n               \n        </ion-item>\n\n        <ion-item>\n           <ion-icon name="school" color="primary" item-left></ion-icon>\n            <h2>School</h2>\n            <p><ion-note>{{userDetail.schoolName}}</ion-note></p>\n        </ion-item>\n\n        \n</ion-list>\n<ion-list no-padding>\n        \n        <ion-item>\n                <ion-icon name="card" color="primary" item-left></ion-icon>\n                <h2>Account</h2>\n                <p>Balance & Fee</p>\n        </ion-item>\n        <ion-item>\n                <ion-icon name="notifications" color="primary" item-left></ion-icon>\n                <h2>Notifications & Sound </h2>\n                <p>Push notification settings</p>\n        </ion-item>\n        \n        <ion-item>\n                <ion-icon name="information" color="primary" item-left></ion-icon>\n                <h2>App Info</h2>\n                <p>Privacy & Terms, Build & Updates</p>\n        </ion-item>\n</ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\Chris\Desktop\Sandbox\SagerEducation\src\pages\about\about.html"*/
        }),
