...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClassSchdulePageModule", function() { return ClassSchdulePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__class_schdule__ = __webpack_require__(915);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic3_calendar_en__ = __webpack_require__(916);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ClassSchdulePageModule = (function () {
    function ClassSchdulePageModule() {
    }
    ClassSchdulePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__class_schdule__["a" /* ClassSchdulePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__class_schdule__["a" /* ClassSchdulePage */]),
    ...
    ], ClassSchdulePageModule);
    return ClassSchdulePageModule;
}());

//# sourceMappingURL=class-schdule.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClassSchdulePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(88);
...
/**
 * Generated class for the ClassSchdulePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ClassSchdulePage = (function (_super) {
    __extends(ClassSchdulePage, _super);
    function ClassSchdulePage(navCtrl, navParams, userService, commonService, classService) {
        ...
        _this.currentMonthEvents = [];
        _this.certainDaySchedule = [];
        _this.header_title = __WEBPACK_IMPORTED_MODULE_3__providers_setting_setting__["a" /* SettingProvider */].pageSettings.ClassSchdulePage.pageTitle;
        _this.selectedDate = '';
        return _this;
    }
    ClassSchdulePage.prototype.onDaySelect = function (event) {
        var _this = this;
        var loading = this.commonService.presentLoading();
        var selectDate = new Date(event.year, event.month, event.date);
        this.selectedDate = selectDate.toDateString();
        var tomorrow = new Date(event.year, event.month, event.date + 1);
        this.userSubscription = this.userService.currentUser.subscribe(function (user) {
            var ucs = new __WEBPACK_IMPORTED_MODULE_4__shared__["l" /* userClassSchedule */]();
            ucs.id = user.id;
            ucs.startDate = selectDate.toISOString();
            ucs.endDate = tomorrow.toISOString();
            _this.classService.getClassSchedule(ucs).subscribe(function (classSchedule) {
                _this.commonService.dismissLoading(loading);
                // for(let i=0; i<classSchedule.length; i++){
                //   console.log(classSchedule[i].startTime)
                // }
                _this.certainDaySchedule = (classSchedule);
                if (_this.currentMonthEvents.length == 0) {
                    var e = {};
                    e["year"] = event.year;
                    e["month"] = event.month;
                    _this.onMonthSelect(e);
                }
            }, function (error) {
                _this.commonService.dismissLoading(loading);
            }, function () {
    ...
    ClassSchdulePage.prototype.onMonthSelect = function (event) {
        var _this = this;
        this.setCurrentMonthEvents([]);
        var loading = this.commonService.presentLoading();
        var monthFirstDate = new Date(event.year, event.month, 1);
        var monthLastDate = new Date(event.year, event.month + 1, 0);
        this.userSubscription = this.userService.currentUser.subscribe(function (user) {
            var ucs = new __WEBPACK_IMPORTED_MODULE_4__shared__["l" /* userClassSchedule */]();
            ucs.id = user.id;
            ucs.startDate = monthFirstDate.toISOString();
            ucs.endDate = monthLastDate.toISOString();
            _this.classService.getClassSchedule(ucs).subscribe(function (classSchedule) {
                _this.commonService.dismissLoading(loading);
                var cs = [];
                for (var i = 0; i < classSchedule.length; i++) {
                    var ds = _this.commonService.getSplitDate(classSchedule[i].date);
                    cs.push(ds);
                }
                _this.setCurrentMonthEvents(cs);
            }, function (error) {
                _this.commonService.dismissLoading(loading);
            }, function () {
            });
    ...
    ClassSchdulePage.prototype.setCurrentMonthEvents = function (events) {
        this.currentMonthEvents = events;
    };
    ClassSchdulePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ClassSchdulePage');
        if (this.currentMonthEvents.length == 0) {
            var date = new Date();
            var e = {};
    ...
    ClassSchdulePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-class-schdule',template:/*ion-inline-start:"C:\Users\Chris\Desktop\Sandbox\SagerEducation\src\pages\class-schdule\class-schdule.html"*/'<ion-header>\n    <page-header [header]="header_title"></page-header>\n</ion-header>\n\n<ion-content>\n  <div>\n  <ion-calendar #calendar [events]="currentMonthEvents" (onDaySelect)="onDaySelect($event)" (onMonthSelect)="onMonthSelect($event)"></ion-calendar>\n  </div>\n  <div>\n  <ion-list>\n    <h5 style="text-align: center;">{{selectedDate}}</h5>\n    <ion-card *ngFor="let class of certainDaySchedule">\n        <ion-card-content>\n            <ion-list>\n                <ion-item>\n                <ion-icon name="book"></ion-icon>\n                {{class.programName}}\n                </ion-item>\n\n                <ion-item>\n                  <ion-icon name="time"></ion-icon>\n                  {{class.startTime}} - {{class.endTime}}\n                </ion-item>\n           \n                <ion-item>\n                  <ion-icon name="locate"></ion-icon>\n                  {{class.campus}}\n                </ion-item>\n\n                <ion-item>\n                  <ion-icon name="school"></ion-icon>\n                  {{class.teacherFirstName}}   {{class.teacherLastName}} \n                </ion-item>\n           \n                <ion-item>\n                  <ion-icon name="color-filter"></ion-icon>\n                  {{class.status}}\n                </ion-item>\n           \n              </ion-list>\n        </ion-card-content>\n     </ion-card>\n  </ion-list>\n</div>\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Chris\Desktop\Sandbox\SagerEducation\src\pages\class-schdule\class-schdule.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__shared__["k" /* UserService */], __WEBPACK_IMPORTED_MODULE_4__shared__["e" /* CommonService */], __WEBPACK_IMPORTED_MODULE_4__shared__["d" /* ClassService */]])
    ], ClassSchdulePage);
    return ClassSchdulePage;
}(__WEBPACK_IMPORTED_MODULE_2__auth_auth__["a" /* AuthPage */]));

//# sourceMappingURL=class-schdule.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_calendar_calendar_module__ = __webpack_require__(917);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__calendar__ = __webpack_require__(918);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_month_name__ = __webpack_require__(920);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(919);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(43), __webpack_require__(471)(module)))
